...
It appears to primarily contain:
- **Shell configuration** (e.g., `.zshrc`, `.aliases`)
- **Git configuration** (e.g., `.gitconfig`, global ignore settings)
- **Terminal/editor/tool configs** (e.g., `ghostty/`, `nvim/`, `fastfetch/`, `opencode/`)
- **Bootstrap helpers** (e.g., `symlink.sh`, `Brewfile`)

## Contents / stack

The repository language mix indicates mostly:
- **Ruby**
- **Shell**
- **Lua**
